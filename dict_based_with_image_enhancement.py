...
# Function to extract requirements using rule-based parsing
...
csv_path = 'requirements.csv'         #Requiremtns also stored in csv
json_path = 'requirements.json'       #output requiremts goes to json file
